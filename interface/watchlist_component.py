...
class WatchList(tk.Frame):
    ...
    def _add_symbol(self, symbol: str, exchange: str):
        ...
        self.body_widgets['symbol'][b_index] = tk.Label(self._body_frame.sub_frame, text = symbol, 
        ...
        self.body_widgets['exchange'][b_index] = tk.Label(self._body_frame.sub_frame, text = exchange, 
                                                        bg = BG_COLOR, fg = FG_COLOR2, font = GLOBAL_FONT, width = self._col_width)
        ...
        self.body_widgets['remove'][b_index] = tkmac.Button(self._body_frame.sub_frame, text = "X", borderless = True,
                                                        ...
                                                        command = lambda : self._remove_symbol(b_index), width = 50)
